...
public class QueryDAO {
	...
	private String ACC_DETAILS_QUERY ="select account_type,account_num,balance,last_transaction_date,"
			+ "is_active from account_info a,user_info u where u.user_name=? and u.user_id=a.user_id";
	
	private String ACC_LIST_QUERY ="select distinct(account_num) from account_info a,"
			+ "user_info u where u.user_name=? and u.user_id=a.user_id";
	
	private String BEN_LIST_QUERY ="select distinct(account_num) from acc_beneficiaries a,"
			+ "user_info u where u.user_name=? and u.user_id=a.user_id";
	...
	private String INSERT_USER_INFO_QUERY="insert into user_info(user_name,password,email,is_admin,first_name,"
			+ "last_name,address,occupation,ssn) values (?,?,?,?,?,?,?,?,?)";
	...
	private String TRANSACTION_HIST_QUERY ="select tr.transaction_date,tr.amount,tr.transaction_type,"
			+ "tr.acct_num,a.account_type from transaction_history tr,user_info u,account_info a "
			+ "where tr.user_id=u.user_id and a.account_num=tr.acct_num and u.user_name=?";

	private String ACC_DETAILS_BY_ID_QUERY="select a.account_type,a.account_num,a.balance,a.last_transaction_date,"
			+ "a.is_active,u.user_name,u.e mail,u.first_name,u.last_name,u.address,u.occupation from account_info a,user_info u"
	...
	private String UPDATE_USER_INFO_QUERY="update user_info u,account_info a set user_name=?,"
			+ "email=?,first_name=?,last_name=?,address=?,occupation =? where a.account_num=? and a.user_id=u.user_id";
